...
console.log(TwoStack.enqueue(1)); // 1
console.log(TwoStack.enqueue(2)); // 2

console.log(TwoStack.stack1.toArr()); // [2, 1],
console.log(TwoStack.stack2.toArr()); // [],
console.log(TwoStack.stack1.isEmpty()); // false
console.log(TwoStack.stack2.isEmpty()); // true

console.log(TwoStack.dequeue());
console.log(TwoStack.dequeue());
console.log(TwoStack.dequeue());
